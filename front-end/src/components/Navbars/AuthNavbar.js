      ...
      <Navbar className="navbar-top navbar-horizontal navbar-dark" expand="md">
        <Container className="">
          <NavbarBrand to="/" tag={Link}>
            <h3 className="text-white"><i className="ni ni-hat-3" /> SAPP | {usuario.nombreCompleto} ({usuario.rol.nombre}) </h3>
          </NavbarBrand>
          ...
          <UncontrolledCollapse navbar toggler="#navbar-collapse-main">
            <div className="navbar-collapse-header d-md-none">
              <Row>
                <Col className="collapse-brand" xs="6">
                  <NavbarBrand to="/" tag={Link}>
                    <small className="text-white"><i className="ni ni-hat-3" /> SAPP | {usuario.nombreCompleto} ({usuario.rol.nombre}) </small>
                  </NavbarBrand>
                </Col>
            ...
            <Nav className="ml-auto" navbar>
              ...
              <NavItem>
                <NavLink className="hand nav-link-icon " onClick={cerrarSesion}tag={Link}>
